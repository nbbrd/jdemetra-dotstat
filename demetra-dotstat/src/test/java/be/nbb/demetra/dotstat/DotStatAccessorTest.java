...
public class DotStatAccessorTest {
    ...
    private static DotStatBean nbbBean() {
        ...
        result.setFlowRef(new FlowRef("NBB", "TEST_DATASET", null));
    ...
    public void testGetKey() throws Exception {
        DataStructure dfs = nbb.AsConnection().getDataStructure(new FlowRef("NBB", "TEST_DATASET", null));
    ...
    public void testGetKeyFromTs() throws Exception {
        try (DataCursor cursor = nbb.AsConnection().getData(new FlowRef("NBB", "TEST_DATASET", null), Key.ALL, true)) {
            cursor.nextSeries();
