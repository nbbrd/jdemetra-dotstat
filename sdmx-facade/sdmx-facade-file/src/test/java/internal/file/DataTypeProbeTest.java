...
public class DataTypeProbeTest {
    ...
    public void testDecodeGeneric20() throws IOException {
        assertThat(DataTypeProbe.of().parseReader(SdmxSource.XIF, SdmxSource.OTHER_GENERIC20::openReader))
                .isEqualTo(SdmxDecoder.DataType.GENERIC20);
    }

    @Test
    public void testDecodeCompact20() throws IOException {
        assertThat(DataTypeProbe.of().parseReader(SdmxSource.XIF, SdmxSource.OTHER_COMPACT20::openReader))
                .isEqualTo(SdmxDecoder.DataType.COMPACT20);
    }

    @Test
    public void testDecodeGeneric21() throws IOException {
        assertThat(DataTypeProbe.of().parseReader(SdmxSource.XIF, SdmxSource.OTHER_GENERIC21::openReader))
                .isEqualTo(SdmxDecoder.DataType.GENERIC21);
    }

    @Test
    public void testDecodeCompact21() throws IOException {
        assertThat(DataTypeProbe.of().parseReader(SdmxSource.XIF, SdmxSource.OTHER_COMPACT21::openReader))
