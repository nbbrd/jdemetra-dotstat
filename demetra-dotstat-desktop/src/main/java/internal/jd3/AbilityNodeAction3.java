 ...
 */
public abstract class AbilityNodeAction3<ABILITY> extends NodeAction {

    private final Class<ABILITY> ability;
    private final boolean single;

    protected AbilityNodeAction3(Class<ABILITY> ability) {
        this(ability, false);
    }

    protected AbilityNodeAction3(Class<ABILITY> ability, boolean single) {
